...
module.exports = {
	port: 443,
	//db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost/mean-yo',
	db: process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://localhost/heroku_qmx8z7v2',
	assets: {
		lib: {
			css: [
